...
class TransformFixMatch_CIFAR10(object):
    def __init__(self, mean, std, seed=None, n=2, m=5):
        self.n = n
        self.m = m
        self.seed = seed
    ...
    def set_seed(self, seed):
        ...
        torch.backends.cudnn.benchmark = False  # Disable CUDNN benchmarking (ensures determinism)

    def __call__(self, x):
        # Ensure consistent randomness with the given seed
        if self.seed is not None:
            self.set_seed(self.seed)
